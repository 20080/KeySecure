...
class verificationPage extends Component{
    ...
    return(
    <div>
    <section className="menu cid-qTkzRZLJNu" once="menu" id="menu1-3">
        ...
        <section className="header5 cid-rYKXTyAteH mbr-fullscreen" id="header5-4">


            <div className="container">
                <div className="row justify-content-center">
                    <div className="mbr-white col-md-10">
                        <h1 className="mbr-section-title align-center pb-3 mbr-fonts-style display-1">Verification
                            Required</h1>
                        <p className="mbr-text align-center display-5 pb-3 mbr-fonts-style">
                            This is the verification section for the requested token if you initiated it you can proceed
                            safely, but if it just poped up some how please <strong><em>report it to us
                            ASAP</em></strong></p>
                        <div className="mbr-section-btn align-center">
                            <a className="btn btn-md btn-secondary display-4">
                                Verify Identity</a>
                            <a className="btn btn-md btn-white-outline display-4" href="#">
                                New User</a></div>
                    </div>
                </div>
            </div>
